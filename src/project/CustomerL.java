package project;
import java.sql.*;
public class CustomerL extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String query = "select Account_Number,Password from customer where Account_Number = "+jTextField1.getText();
            ...
            if(pass.compareTo(jTextField2.getText())==0) {
                ...
                new CustomerLogin(rs.getInt(1)).setVisible(true);
            } else {
                this.setVisible(false);
                new WrongIdOrPassword(3).setVisible(true);
            }
        }
        catch(Exception e) {
            this.setVisible(false);
