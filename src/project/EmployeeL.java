...
public class EmployeeL extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String query = "select Employee_ID,password from employee where Employee_ID = "+jTextField1.getText();
            ...
            if(pass.compareTo(jTextField2.getText())==0) {
                ...
                new EmployeeLogin(rs.getInt(1)).setVisible(true);
            } else {
                this.setVisible(false);
                new WrongIdOrPassword(2).setVisible(true);
            }
        }
        catch(Exception e) {
            this.setVisible(false);
